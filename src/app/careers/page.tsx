...
const evpCards = [
  {
    icon: (
      <svg className="w-8 h-8 text-[#DB1B0C]" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    icon: (
      <svg className="w-8 h-8 text-[#DB1B0C]" viewBox="0 0 32 32" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        <path d="M2 28c0-4.418 3.582-8 8-8M22 20c4.418 0 8 3.582 8 8M16 20c3.314 0 6 2.686 6 6" strokeLinecap="round"/>
      </svg>
    ),
    title: 'Collaboration',
    ...
    <>
            ...
            {evpCards.map((card, i) => (
              <Reveal key={card.title} variant="scale" delay={i * 0.12}>
                <div className="bg-[#f3f5f5] flex flex-col items-center gap-4 p-7 text-center fipl-card-hover h-full">
                  <div style={{ animation: `floatOrb ${3 + i * 0.5}s ease-in-out ${i * 0.3}s infinite` }}>
                    {card.icon}
                  </div>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <Reveal variant="right" delay={0.15}>
              <div>
                <span className="inline-flex items-center gap-1.5 text-sm text-[#DB1B0C] mb-3">We are FIPL <BoltIcon /></span>
                ...
                <p className="text-[#797979] leading-relaxed mb-6 text-base">
                  ...
                  we generate comes from a place of excellence and responsibility.
                </p>
                <div className="space-y-4">
                  {[
                    ...
                    { title: 'Collaboration & Sustainability', desc: 'We achieve more, together and are committed to lasting impact.' },
                  ].map(({ title, desc }, i) => (
      ...
      <section id="open-roles" className="py-12 md:py-16 lg:py-20">
        <div className="max-w-[1280px] mx-auto px-6">
          <Reveal variant="up">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <span className="inline-flex items-center gap-1.5 text-sm text-[#DB1B0C] mb-3">Join our Talent Pool <BoltIcon /></span>
                ...
                <div className="bg-white border border-gray-200 p-6 hover:border-[#DB1B0C] hover:shadow-md transition-all fipl-card-hover h-full">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-10 h-10 rounded-full bg-[#DB1B0C]/10 flex items-center justify-center shrink-0">
                      <svg className="w-5 h-5 text-[#DB1B0C]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="flex items-center gap-2 text-xs text-[#797979] mb-1">
                    ...
                    <span className="ml-2 flex items-center gap-1">
                      <svg className="w-3.5 h-3.5 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg>
                      {job.dept}
                    </span>
                  </div>
                  <Link href="#" className="inline-flex items-center gap-1 text-sm font-semibold text-[#DB1B0C] mt-4 hover:gap-2 transition-all">
                    Apply Now ↗
                  </Link>
                </div>
              </Reveal>
