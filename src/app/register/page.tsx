    ...
    answer: (
      <ul className="space-y-2 mt-1">
        {[
          ...
          <li key={item} className="flex items-start gap-2 text-[var(--fipl-body)] text-sm">
...
export default function RegisterPage() {
  return (
    <div className="page-bolt-bg">
      ...
      <section className="py-12 md:py-16 bg-[var(--fipl-surface)]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <Reveal variant="up" delay={0.15}>
            ...
            <div className="mt-10 border-l-4 border-[#DB1B0C] bg-[#DB1B0C]/5 p-5">
              ...
              <p className="text-sm text-[var(--fipl-body)] mb-2">
              ...
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2 text-sm text-[var(--fipl-body)]">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-[var(--fipl-body)] leading-relaxed italic">
              ...
              {[
                {
                  ...
                  content: (
                    <a
                      ...
                      className="text-sm text-[var(--fipl-body)] hover:text-[#DB1B0C]"
                    >
                ...
                <Reveal key={title} variant="up" delay={i * 0.1}>
                  <div className="border border-[var(--fipl-border)] p-6 fipl-card-hover h-full">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-9 h-9 bg-[#DB1B0C]/10 rounded-xl flex items-center justify-center shrink-0">
                        {icon}
                      </div>
                      <h3 className="font-bold text-[var(--fipl-heading)] text-sm">{title}</h3>
                    </div>
                    {content}
                  </div>
                </Reveal>
