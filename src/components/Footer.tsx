              ...
              {[
                {
                  ...
                  label: 'Address Location', value: '12 Circular Road, Presidential Estate, GRA, Port Harcourt',
                },
                {
                  icon: (
                    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  label: 'Phone Number', value: '+234 (0) 908 102 2226',
                },
                {
                  icon: (
                    <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  label: 'Email address', value: 'info@fipl-ng.com',
                },
