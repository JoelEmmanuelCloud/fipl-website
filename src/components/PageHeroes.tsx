          ...
          {ready && (
            <div
              style={{
                ...
                animation: 'heroRuleGrow 0.7s ease 1.1s both',
              }}
            />
          )}
        </div>
          ...
          {ready && (
            <div
              style={{
                ...
                animation: 'heroStatIn 0.65s ease 1.1s both',
              }}
            >
              {(
                [
                  ['541 MW', 'Total Capacity'],
                  ['4', 'Strategic Plants'],
                  ['100%', 'Reliability'],
                ] as [string, string][]
              ).map(([val, lbl], i) => (
          ...
          {ready && (
            <div
              style={{
                ...
                marginTop: 16,
                transformOrigin: 'left',
                animation: 'heroRuleGrow 0.7s ease 1s both',
              }}
            />
          )}
          {ready && (
        ...
        <div className="w-full max-w-[1280px] mx-auto px-6 py-16 text-center">
          ...
          <h1
            style={{
              fontFamily: 'Arial',
              fontWeight: 700,
              fontSize: 'clamp(27px, 4.8vw, 54px)',
              lineHeight: 1.25,
              color: 'white',
            }}
          >
          ...
          {ready && (
            <div
              style={{
                ...
                width: 200,
                transformOrigin: 'center',
                animation: 'heroRuleGrow 0.6s ease 1.05s both',
              }}
            />
          )}
          {ready && (
            <div
              style={{
                ...
                gap: 28,
                marginTop: 16,
                animation: 'heroStatIn 0.6s ease 1.2s both',
              }}
            >
              <a
                href="tel:+23412620375"
                style={{
          ...
          {ready && (
            <div
              style={{
                height: 2,
                width: 160,
                background: 'linear-gradient(90deg, transparent, #D97300, #F47820, transparent)',
                margin: '16px auto 0',
                transformOrigin: 'center',
                animation: 'heroRuleGrow 0.7s ease 1s both',
              }}
