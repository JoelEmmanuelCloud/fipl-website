...
export const defaultAboutContent: AboutContent = {
  ...
  coreValues: [
    ...
    { title: 'Integrity', desc: 'To maintain integrity through discipline in all our actions.' },
    {
  ...
  ceo: { heading: 'Meet The CEO', subheading: 'A video address from our Chief Executive Officer' },
  integrity: {
...
export const defaultPowerPlantsContent: PowerPlantsContent = {
  intro: {
